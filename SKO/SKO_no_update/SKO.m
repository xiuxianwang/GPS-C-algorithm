...
A_Opti_Record_gap = cell(30,1);
% repeat 30 times and fix random seed
for ii = 1:30
    s_rand = RandStream('mt19937ar','Seed',ii);
...
%--------------------------------------------------------------------------
    ...
    ss1 = num2cell(f_min(1:max_evaluation-num_initial+1)',2);
    ss2 = num2cell(optimum*ones(1,max_evaluation-num_initial+1)-f_min(1:max_evaluation-num_initial+1)',2);
    A_Opti_Record(ii,1) = ss1;
    A_Opti_Record_gap(ii,1) = ss2;
end
