...
for i_i = 1:30
    ...
    s_rand = RandStream('mt19937ar','Seed',i_i);
...
% Step2 - iteration
    ...
    % record the results of each replication
    A_Opti_Record(i_i,1:MaxSteps) = Opti_Record(1:MaxSteps);
    A_Opti_Record_gap(i_i,1:MaxSteps) = Opti_Record_gap(1:MaxSteps);
