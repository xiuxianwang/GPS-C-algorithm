...
skriging_model = SKfit2(SSample(:,1:d),SSample(:,d+2),B,2);   %fit a kriging model (this kriging method differs from the Function SKfit, since it intensionally returns larger tau2hat for better exploration in early stage of the algorithm)
...
if (step < 28)
    ...
    skriging_model = SKfit2(SSample(:,1:d),SSample(:,d+2),B,2);  
